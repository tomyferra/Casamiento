...
function CeremoniaYFiesta() {
  return (
    <div id="Detalles" className="flex-col p-11 secondaryColor font-Montserrat text-white flex items-center justify-center">
      ...
      <a target="_blank" href="https://maps.app.goo.gl/2iSsveYe3gT2kWkM9" className="p-2 m-2 border bg-white hover:bg-transparent hover:text-black text-black py-2 px-4 rounded-full">COMO LLEGAR</a>
    </div>
  )
}
